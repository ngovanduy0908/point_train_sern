    ...
    >
      ...
      <div className="container__header">
        ...
        <div className="container__header-info">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="">Lớp: {studentData[0]?.class_name}</div>
            <div className="">Khoá: {studentData[0]?.course_name}</div>
            <div className="">Khoa: {studentData[0]?.department_name}</div>
          </div>
          <div className="grid grid-cols-4 gap-4">
      ...
      <div className="container__content">
        <table className="table table-bordered">
          ...
          <tr>
            ...
            <th className="w-[10%] textCenter">
              Điểm do sinh viên tự đánh giá
            </th>
            <th className="w-[10%] textCenter">Điểm do lớp đánh giá</th>
            <th className="w-[10%] textCenter">
          ...
          <tr>
            <td colSpan={`${colSpan}`}>
              <p>
                ...
                (tổng điểm có thể chấm quá 30 khi SV đạt giải NCKH, thi Olimpic
                cấp Bộ hoặc cấp Quốc gia)
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td colSpan={`${colSpan}`}>
              ...
              khác:
              <span>
                (cộng điểm thưởng theo QĐ số 1171/QĐ-MĐC ngày 12/11/2020 về quản
                lý KHCN của trường Đại học Mỏ-Địa chất)*
              </span>
            </td>
          </tr>
          ...
          <tr>
            <td width="70%">
              ...
              (+6đ) <br />- Đạt giải Olympic cấp Quốc gia tối đa:
              ………...…………………….(+10đ) <br />- Tham gia Olympic cấp Quốc gia tối
              đa: ………...…… ..……….…....(+6đ) <br />- Đạt giải Olympic cấp Trường
              tối đa:
              …........................................................(+5đ){" "}
              <br />- Tham gia Olympic cấp Trường tối đa: ………...……….
              …….............(+2đ)
            </td>
            <td>
              <input
          ...
          <tr>
            <td width="70%">
              a). Đã đăng ký, nhưng bỏ không tham tham gia nghiên cứu khoa học,
              thi Olympic, Robocon và các cuộc thi khác tương đương:
              ........................ (-15đ)
            </td>
            <td>
              <input
          ...
          <tr>
            <td width="70%">
              <h5 className="font-bold">Cộng mục I</h5>
            </td>
            <td>
              <input
                type="number"
            ...
            <td colSpan={`${colSpan}`}>
              <p>
                ...
                >
                  II.
                  <u>
                    Đánh giá về ý thức và kết quả chấp hành nội quy, quy chế của
                    Trường
                  </u>
                </span>{" "}
                <span style={{ fontStyle: "italic" }}>
          ...
          <tr>
            <td width="70%">
              a). Chấp hành tốt nội quy, quy chế của Trường, không vi phạm kỷ
              luật….(+10đ)
            </td>
            <td>
              <input
          ...
          <tr>
            <td width="70%">
              a). Không tham gia học tập đầy đủ, nghiêm túc nghị quyết, nội quy,
              quy chế, tuần sinh hoạt công dân sinh
              viên:..…....................................................(-10đ)
            </td>
            <td>
              <input
          ...
          <tr>
            <td width="70%">
              <h5 className="font-bold">Cộng mục II</h5>
            </td>
            <td>
              <input
                type="number"
              ...
              <p>
                <span style={{ fontWeight: "bold" }}>
                  ...
                  <u>
                    ...
                    trị, xã hội, văn hoá, văn nghệ, thể thao, phòng chống các tệ
                    nạn xã hội
                  </u>
                </span>{" "}
                <span style={{ fontStyle: "italic" }}>
          ...
          <tr>
            <td width="70%">
              a). Tham gia đầy đủ các hoạt động, sinh hoạt do Trường, Khoa, Lớp,
              Đoàn TN, Hội SV tổ
              chức:......................................................................…….(+13đ)
            </td>
            <td>
          ...
          <tr>
            <td colSpan={`${colSpan}`}>
              b). Có thành tích hoạt động chính trị, xã hội, văn hoá, văn nghệ,
              thể thao, đoàn thể và đấu tranh phòng chống các tệ nạn xã hội được
              tuyên dương, khen thưởng (lấy mức khen thưởng cao nhất):
            </td>
          </tr>

          <tr>
            <td width="70%">
              - Cấp Trường: ……………………….……………….……………...… (+3đ) <br />- Cấp tỉnh,
              thành phố trở lên:……...……...………………..................... (+5đ)
            </td>
            <td>
              <input
                type="number"
                ...
                min="0"
                max="3"
                value={values.svAchievementSchool + values.svAchievementCity}
              />
            </td>
            <td>
              <input
                ...
                max="3"
                value={
                  valuesLT.ltAchievementSchool + valuesLT.ltAchievementCity
                }
              />
            </td>
            <td>
              <input
                ...
                max="3"
                value={
                  valuesGV.gvAchievementSchool + valuesGV.gvAchievementCity
                }
              />
            </td>
          </tr>
          ...
          <tr>
            <td width="70%">
              <h5 className="font-bold">Cộng mục III</h5>
            </td>
            <td>
              <input
                type="number"
          ...
          <tr>
            <td colSpan={`${colSpan}`}>
              <p>
                <span style={{ fontWeight: "bold" }}>
                  IV.
                  <u> Đánh giá về phẩm chất công dân và quan hệ công đồng </u>
                </span>{" "}
                <span style={{ fontStyle: "italic" }}>
                  (Tổng điểm: 0 - 15 điểm)
                </span>
          ...
          <tr>
            <td>
              ...
              đồng; phong trào thanh niên tình nguyện; phong trào giúp đỡ nhân
              dân và bạn bè khi gặp thiên tai, khó khăn, hoạn
              nạn:...................................................................(+5đ)
            </td>
            <td>
              <input
          ...
          <tr>
            ...
            <td>
              <input type="number" name="svWarn" id="" value={values.svWarn} />
            </td>
            <td>
              <input
                type="number"
          ...
          <tr>
            <td width="70%">
              <h5 className="font-bold">Cộng mục IV</h5>
            </td>
            <td>
              <input
                type="number"
            ...
            <td colSpan={`${colSpan}`}>
              <p>
                <span style={{ fontWeight: "bold" }}>
                  V.
                  <u>
                    Đánh giá về ý thức và kết quả tham gia phụ trách lớp, các
          ...
          <tr>
            <td colSpan={`${colSpan}`}>
              a). Là thành viên Ban cán sự lớp quản lý sinh viên, cán bộ Đoàn
              TN, Hội SV hoàn thành nhiệm vụ:
            </td>
          </tr>
          ...
          <tr>
            <td width="70%">
              - Là thành viên Ban cán sự lớp quản lý sinh viên, lớp học phần;
              cán bộ Đoàn TN, Hội SV thiếu trách nhiệm với tập thể
              lớp:...................................(-5đ/lần)
            </td>
            <td>
              <input
          ...
          <tr>
            <td width="70%">
              <h5 className="font-bold">Cộng mục V</h5>
            </td>
            <td>
              <input
                type="number"
          ...
          <tr class="sum_all">
            <td>
              <h5 className="font-bold">Tổng Cộng: </h5>
            </td>
            <td>
              <input type="number" className="font-bold" value={sum} />
            </td>
            <td>
              <input type="number" className="font-bold" value={sumlt} />
            </td>
            <td>
              <input type="number" className="font-bold" value={sumgv} />
            </td>
          </tr>
          {/* </tbody> */}
        </table>
        <p className="text-[13px]">
          <span className="underline italic font-bold">Ghi chú:</span> 1. Sinh
          viên bị kỷ luật với các hình thức: Khiển trách: hạ 01 mức xếp loại rèn
          luyện; Cảnh cáo: hạ 02 mức xếp loại rèn luyện và tối đa đạt mức trung
          bình; Đình chỉ học tập 01 năm: xếp loại rèn luyện dưới mức trung bình.
          <br />
          2. Sinh viên không đánh giá kết quả rèn luyện, xếp điểm rèn luyện bằng
          0. Sinh viên có kết quả rèn luyện 02 học kỳ liên tiếp loại kém thì
          phải tạm ngừng học tập 01 năm, kết quả rèn luyện 04 học kỳ liên tiếp
          loại kém thì bị buộc thôi học. <br /> 3. Với các SV đạt giải NCKH và
          Olympic cấp quốc gia có điểm cộng ở mục I vượt 30 điểm, và các sinh
          viên tham gia các hoạt động chính trị, văn hóa xã hội ở mục III có
          điểm cộng vượt quá 20 điểm, điểm tổng vượt 100 điểm thì lấy điểm rèn
          luyện bằng 100 điểm.
        </p>
        <ul className="flex justify-between mx-[10px] mt-[5px]">
          <li className="flex flex-col items-center">
            <span className="font-bold text-[15px]">BCN KHOA</span>
            <span>(Ký, đóng dấu)</span>
          </li>
          <li className="flex flex-col items-center">
            <span className="font-bold text-[15px]">GIÁO VIÊN CHỦ NHIỆM</span>
            <span>(Ký, ghi rõ họ tên)</span>
          </li>
          <li className="flex flex-col items-center">
            <span className="font-bold text-[15px]">LỚP TRƯỞNG</span>
            <span>(Ký, đóng dấu)</span>
          </li>
          <li className="flex flex-col items-center">
            <span className="font-bold text-[15px]">SINH VIÊN</span>
            <span>(Ký, đóng dấu)</span>
          </li>
        </ul>
      </div>
...
export default FormPhieuChamPrint;
